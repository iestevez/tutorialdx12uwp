...
void Game::Update(DX::StepTimer const& timer)
{
    ...
    XMMATRIX projection = XMMatrixPerspectiveFovLH(0.25 * XM_PI, static_cast<float>(m_outputWidth) / static_cast<float>(m_outputHeight), 0.5f, 1000.0f);
...
void Game::Clear()
{
   ...
   // Avanzamos hasta el buffer correcto
...
void Game::CreateMainInputFlowResources(const Mesh& mesh) {
    ...
    */
    ...
    // Heap properties and resource Descriptor
    ...
    */
    ...
    heapProperties = CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE_UPLOAD);
    resourceDesc = CD3DX12_RESOURCE_DESC::Buffer(elementSize);
